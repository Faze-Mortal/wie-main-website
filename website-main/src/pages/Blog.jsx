...
export const blogData = [
  ...
  { id: 11, excerpt: "Master essential techniques to clean messy data and turn raw numbers into reliable, actionable insights.", imageUrl: "/blog11.webp", readMoreUrl: "https://medium.com/@ieee.wiemuj/data-cleaning-techniques-every-analyst-should-know-0a9ab0adbb50" },
  { id: 10, excerpt: "When technology hits its limits, human intuition steps in — explore the critical moments that define man vs machine.", imageUrl: "/blog10.webp", readMoreUrl: "https://medium.com/@ieee.wiemuj/what-happens-when-systems-fail-and-humans-take-over-8120ed4c2ae5" },
  { id: 9, excerpt: "Step into the metaverse — a beginner's guide to virtual worlds redefining how we live, work and connect.", imageUrl: "/blog9.webp", readMoreUrl: "https://medium.com/@ieee.wiemuj/exploring-the-metaverse-your-guide-to-the-virtual-universe-5dace13f5716" },
  { id: 8, excerpt: "In a world obsessed with data, where does gut feeling fit in? Explore the balance between intuition and logic.", imageUrl: "/blog8.webp", readMoreUrl: "https://medium.com/@ieee.wiemuj/the-inner-algorithm-balancing-intuition-and-logic-in-a-data-driven-world-f54a4a282f6c" },
  { id: 7, excerpt: "Engineering solves problems, but design thinking asks the right questions first — here's why it matters.", imageUrl: "/blog7.webp", readMoreUrl: "https://medium.com/@ieee.wiemuj/why-every-engineer-should-learn-design-thinking-971f8d897604" },
  { id: 6, excerpt: "What if learning wasn't about memorizing but discovering? A fresh take on breaking rote education.", imageUrl: "/blog6.webp", readMoreUrl: "https://medium.com/@ieee.wiemuj/disrupt-the-cycle-from-cramming-to-curiosity-8c06506a6bcc" },
  { id: 5, excerpt: "From unconscious human bias to algorithmic prejudice — how bias quietly shapes decisions in minds and machines.", imageUrl: "/blog5.webp", readMoreUrl: "https://medium.com/@ieee.wiemuj/the-hidden-biases-in-our-minds-and-machines-7bf9fa102a8c" },
  { id: 4, excerpt: "Everything you need to know about pursuing a Master's degree abroad — from choosing countries to packing your bags.", imageUrl: "/blog4.webp", readMoreUrl: "https://medium.com/@ieee.wiemuj/from-dreams-to-departure-your-complete-roadmap-to-a-masters-abroad-9a7b1f7d3eb1" },
  { id: 3, excerpt: "Why can't we stop scrolling? Dive into the psychology behind doomscrolling and how to find your way back.", imageUrl: "/blog3.webp", readMoreUrl: "https://medium.com/@ieee.wiemuj/the-endless-scroll-unraveling-the-psychology-of-doomscrolling-and-finding-our-way-back-0c5e3aacb8d9" },
  { id: 2, excerpt: "The syllabus is just the starting point — the most valuable learning happens outside the classroom.", imageUrl: "/blog2.webp", readMoreUrl: "https://medium.com/@ieee.wiemuj/control-alt-curiosity-why-every-student-should-explore-beyond-the-syllabus-4891ec6b7313" },
  { id: 1, excerpt: "The internet is evolving — from centralized giants to a decentralized future. Here's what Web 3.0 means for us.", imageUrl: "/blog1.webp", readMoreUrl: "https://medium.com/@ieee.wiemuj/the-decentralized-web-e348bf6829d2" },
];
