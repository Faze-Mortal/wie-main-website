...
export const galleryPhotos = [
  ...
  { id: 7, src: '/Gallery/IMG-7.jpg', cat: 'ieee-summit', caption: 'Summit Success', description: 'IEEE summit of 2025' },
  { id: 8, src: '/Gallery/IMG-8.jpg', cat: 'fun-moments', caption: 'Pure Joy', description: 'moments' },
  { id: 9, src: '/Gallery/IMG-9.jpg', cat: 'elysium', caption: 'Night Vibes', description: 'last night perm of elysium 20' },
  ...
  { id: 13, src: '/Gallery/IMG-13.jpg', cat: 'moments', caption: 'Together We Learn', description: 'indulged participant(moment)' },
  { id: 14, src: '/Gallery/IMG-14.jpg', cat: 'fun-moments', caption: 'Smiles All Around', description: 'moment' },
  ...
  { id: 25, src: '/Gallery/IMG-25.jpg', cat: 'group-photo', caption: 'Moments That Matter', description: 'cc summit group photo' },
  ...
  { id: 28, src: '/Gallery/IMG-28.jpg', cat: 'group-photo', caption: 'Through the Lens', description: 'cc summit group photo of wie' },
  ...
  { id: 39, src: '/Gallery/IMG-39.jpg', cat: 'cc-summit', caption: 'A New Beginning', description: 'circle of destruction' },
  { id: 40, src: '/Gallery/IMG-40.jpg', cat: 'fun-moments', caption: 'Unscripted', description: 'first cc celebration' },
  ...
  { id: 48, src: '/Gallery/IMG-48.jpg', cat: 'group-photo', caption: 'One Frame', description: 'confluence group photo' },
  ...
  { id: 52, src: '/Gallery/IMG-52.jpg', cat: 'group-photo', caption: 'The Grand Finale', description: "EC's group photo" },
  ...
  { id: 60, src: '/Gallery/IMG-60.jpg', cat: 'elysium', caption: 'Inspiring Voices', description: 'felicitation of confluence Raghav Garg' },
  { id: 61, src: '/Gallery/IMG-61.jpg', cat: 'moments', caption: 'Picture This', description: "confluence aishwarya's speech" },
